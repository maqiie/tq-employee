  ...
  const fetchAgentTransactions = async (agentId) => {
    try {
      ...
      try {
        ...
        const response = await fetch(`http://192.168.1.200:3001/employees/agents/${agentId}/transactions`, {
          method: 'GET',
          headers: headers,
        });
        ...
        const allTransactionsResponse = await fetch(`http://192.168.1.200:3001/employees/${employeeId}/transactions`, {
          method: 'GET',
          headers: headers,
        });
